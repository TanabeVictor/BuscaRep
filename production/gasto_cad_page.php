                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php while($dado = mysqli_fetch_array($resultado)){ ?>
                     <form action="gasto_insert.php?id=<?php echo $dado["id"] ?>" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  id="value" step=0.01 type="number" name="value" class="form-control" required="required" placeholder="R$ __,__">
                        </div>
                      </div>
