  ...
  <body class="nav-md">
                  ...
                  <div class="x_content">
                    ...
                    <form action="http://localhost/production/BuscaRep/production/rep_insert.php" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="cod-estados" class="form-control col-md-7 col-xs-12" name="state" required>                        
							<?php while($row = $res->fetch_assoc()):?>
								<option value="<?= $row['cod_estados']?>"><?= $row['nome']?></option>
							<?php endwhile; ?>
                          </select>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <select id="cod-cidades" class="form-control col-md-7 col-xs-12" name="city" required>                 
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="street" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="street" placeholder="Nome da Rua" required="required" type="text">
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="neighboor" class="form-control col-md-7 col-xs-12"  name="neighboor" placeholder="Bairro" data-validate-length-range="6" data-validate-words="1" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="number" class="form-control col-md-7 col-xs-12" name="number" placeholder="Número da Residência" required="required" type="number" step=1>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="email" placeholder="Endereço de e-mail" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="qtd" class="form-control col-md-7 col-xs-12" name="qtd" placeholder="Número de Vagas" required="required" type="text">
                        </div>
                      </div>
    ...
    <script>
      ...
      $('form').submit(function(e) {
		...
		$(document).ready(function(){
			$("#cod-estados").change(function() {
				
				$("#cod-cidades").attr("disabled",true);
				$.get("http://localhost/SiteBuscaRep/production/cidades.ajax.php?id="+$(this).val(),function(data,status){
					var options = "";
					console.log(data);
					data = JSON.parse(data);
					$("#cod-cidades").removeAttr("disabled");	
					
					data.forEach(function(item,key){
						options+= "<option value=\""+item.cod_cidades+"\">"+item.nome+"</options>";
					});

					$("#cod-cidades").empty().append(options);
