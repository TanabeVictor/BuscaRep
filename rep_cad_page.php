                  ...
                  <div class="x_content">
                    ...
                    <form action="rep_insert.php" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="street" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="street" placeholder="Nome da Rua" required="required" type="text">
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="neighboor" class="form-control col-md-7 col-xs-12"  name="neighboor" placeholder="Bairro" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="cellphone" class="form-control col-md-7 col-xs-12" type="text" name="cellphone">
                        </div>
					  </div>
                      <div class="item form-group">
                      ...
                      <label for="services">Serviços e Gerais(TV a Cabo, Piscina, etc):</label>
                          <textarea id="services" required class="form-control" name="services" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
