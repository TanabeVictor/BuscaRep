                  ...
                  <div class="x_content">
                    <br />
                       <?php while($dado = mysqli_fetch_array($resultado)){ ?>
                     	<form action="rep_update.php?id=<?php echo $dado["id"]?>" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="name" placeholder="Nome da República" required="required" value="<?php echo $dado["name"]; ?>" type="text">
                        </div>
                      </div>
                       
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Data de Criação <span class="required"></span>
                        </label>
                         <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="creation" name="creation" class="date-picker form-control col-md-7 col-xs-12" value ="<?php echo $dado["creation"] ?>" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="street">Rua <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="street" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="street" placeholder="Nome da Rua" value="<?php echo $dado["street"]; ?>" required="required" type="text">
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="neighboor" class="form-control col-md-7 col-xs-12" value="<?php echo $dado["neighboor"]; ?>" name="neighboor" placeholder="Bairro" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="complement" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="complement" value="<?php echo $dado["complement"]; ?>" placeholder="Informações Adicionais" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="email" value="<?php echo $dado["email"]; ?>" placeholder="Endereço de e-mail" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="phone">Telefone Fixo</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="phone" class="form-control col-md-7 col-xs-12" value="<?php echo $dado["phone"]; ?>" type="text" name="phone">
                        </div>
					  </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" for="cellphone">Celular</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="cellphone" class="form-control col-md-7 col-xs-12" value="<?php echo $dado["cellphone"]; ?>" type="text" name="cellphone">
                        </div>
					  </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="qtd">Quantidade de Vagas <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="qtd" class="form-control col-md-7 col-xs-12" name="qtd" value="<?php echo $dado["qtd"]; ?>" placeholder="Número de Vagas" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="agency" class="form-control col-md-7 col-xs-12" name="agency" value="<?php echo $dado["agency"]; ?>" placeholder="Nome da empresa / pessoa locadora" required="required" type="text">
                        </div>
                      </div>
                      <label for="services">Serviços e Gerais(TV a Cabo, Piscina, etc):</label>
                          <textarea id="services" required class="form-control" name="services" value="<?php echo $dado["services"]; ?>" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
