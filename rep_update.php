...
$comando = "UPDATE republica SET name=('$name'), creation=('$creation'), type=('$type'), state=('$state'), city=('$city'), street=('$street'), neighboor=('$neighboor'), complement=('$complement'), email=('$email'), phone=('$phone'), cellphone=('$cellphone'), qtd=('$qtd'), services=('$services'), agency=('$agency') WHERE id=('$id')";
