                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3><?php echo $dado["name"]; ?></h3>
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img src="upload/<?php echo $dado["img_name"];?>" width="200px"
						  height="200px" alt="Avatar">
                        </div>
                      </div>
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li><em class="fa fa-map-marker user-profile-icon"></em> <?php echo $dado["street"];?> , <?php echo $dado["number"];?> , <?php echo $dado["neighborhood"];?> , <?php echo $dado["complement"]; ?></li>
                        <li>
                    ...
                    <br>
                      ...
                      <ul class="list-unstyled user_data">
                        <li>
                          ...
                          <p><?php echo $dado["dweller"]; ?> / <?php echo $dado["qtd"]; ?></p>
                        </li>
                        <li>
