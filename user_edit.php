                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <?php while($dado = mysqli_fetch_array($resultado)){ ?>
                    <form action="user_update.php?id=<?php echo $dado["user"]?>" method="POST" id="form" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="lastname" class="form-control col-md-7 col-xs-12" type="text" name="lastname" value = "<?php echo $dado["lastname"] ?>">
                        </div>
                      </div>
