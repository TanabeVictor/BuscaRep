      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count"><span class="count_top"><em class="fa fa-user"></em> Total Usuários</span>
              <div class="count">2500</div>
              <span class="count_bottom"><i class="green">4% </i> Desde a Última Semana</span>
            </div>
            
             <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-home"></i> Repúblicas Adicionadas</span>
              <div class="count">1235</div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> Desde a Última semana</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                      ...
                      <li>
                        <div class="block">
                          <div class="block_content">
                            <h2 class="title">
                                              <a> Atualização V1.2</a>
                                          </h2>
                            <div class="byline">
                              <span>2 hours ago</span> by <a>Victor Pereira</a>
                            </div>
                            <p class="excerpt">Sejam bem vindos à nova atualização do sistema BuscaRep...<a>Read&nbsp;More</a>
                            </p>
                          </div>
                        </div>
                      </li>
    ...
    <script>
      ...
      echartBar.setOption({
        ...
        series: [{
          ...
          name: 'purchases',
          type: 'bar',
          data: [2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 90, 48.7, 18.8, 6.0, 2.3],
          markPoint: {
            data: [{
              name: 'sales',
              value: 90,
