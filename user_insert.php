...
$result_msg_contato = "INSERT INTO usuario(user, name, lastname, email, password, confirmpassword, birthday) VALUES ('$user','$name', '$lastname', '$email', '$password', '$confirm', '$birthday')";
