                          ...
                          <?php while($dado = mysqli_fetch_array($resultado)){ ?>
                           <tr class="even pointer">
                            ...
                            <td> <button type="button" class="btn btn-success btn-xs">Ativo</button></td>
                           	<td class="a-right a-right "><?php echo $dado["birthday"]; ?></td>
                            <td>
                            <a href="user_edit.php?id=<?php echo $dado["user"] ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
                            <a href="user_delete.php?id=<?php echo $dado["user"] ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Deletar </a>
                          	</td>
                          </tr>
                          <?php } ?>
                        </tbody>
