...
$comando = "INSERT INTO acessante(user, name, lastname, address, email, phone, gender, birthday, password, confirmpassword) VALUES ('$user','$name', '$lastname', '$address', '$email', '$phone','$gender', '$birthday', '$password', '$confirm')";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    Acessante cadastrado com sucesso!
                  </div>
                </div>
              </div>
            </div>
